...
describe("Paginação", () => {
  ...
  describe("getPaginationStatus", () => {
    ...
    it("deve indicar não ser a última página quando existe link 'next'", () => {
      const linkHeader = '<https://api.example.com/items?page=2&per_page=10>; rel="next", <https://api.example.com/items?page=5&per_page=10>; rel="last"';
    ...
    it("deve indicar ser a última página quando não existe link 'next'", () => {
      const linkHeader = '<https://api.example.com/items?page=1&per_page=10>; rel="first", <https://api.example.com/items?page=3&per_page=10>; rel="last"';
